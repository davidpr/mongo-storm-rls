...
public class BoltDtProcessor2 extends BoltDtProcessorBase2 implements Serializable{//
  static Logger LOG = Logger.getLogger(BoltDtProcessor2.class);
  ...
  public void execute(Tuple tuple) {
      if (this.inThread) {
          ...
          if(this.firstuple) {
           this.firstuple=false;

          this.collection = this.db.getCollection(this.collectionNameProcessor);
